...
from datasets.dataset import load_data, TaskDataset
from datasets.tokenizer import SmilesTokenizer, AATokenizer
from models.bert import BERT, BERTPred
from models.bert_trainer import BertPredTrainer
...
def main(args, config):
    ...
    pred_model = BERTPred(model, device)

    logger.info(f"Start training")
    trainer = BertPredTrainer(pred_model, args.output_dir, **config.train)
